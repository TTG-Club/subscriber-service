...
import club.ttg.subscriber.domain.subscription.rest.dto.RedeemCodeRequest;
...
public class SubscriptionController {
    ...
    @Secured("USER")
    @Operation(summary = "Реал-тайм статус подписки текущего пользователя")
    @GetMapping("/status")
    public SubscriptionStatusResponse status() {
        return subscriptionService.statusFor(SecurityUtils.currentUsername());
    }
