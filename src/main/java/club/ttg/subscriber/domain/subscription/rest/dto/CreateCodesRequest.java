 ...
 *                           для подписки из пресета тира по умолчанию GIFT)
 * @param subscriptionMonths срок подписки в месяцах; null — берётся из пресета тира,
 *                           если тот его несёт, иначе код без подписки
